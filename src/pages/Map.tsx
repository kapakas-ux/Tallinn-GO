                ...
                <div class="flex items-center gap-3">
                  ...
                  <div class="text-right flex items-baseline gap-1">
                    ...
                    <span class="font-headline font-black text-lg text-primary">
                      ${(() => { const depSec = (d as any).departureTimeSeconds; const m = depSec ? Math.max(0, Math.floor((depSec - Date.now() / 1000) / 60)) : d.minutes; return m <= 1 ? 'Now' : (m <= 59 ? m + ' min' : (d.time ?? m + ' min')); })()}
                    </span>
                  </div>
                </div>
              </div>
